      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-text">
            <p>&copy; 2025 Jyoti Sah. All rights reserved.</p>
            <p className="footer-quote">Building digital experiences with code & creativity</p>
          </div>

          {/* Social Links */}
          <div className="social-links">
            <a href="https://github.com/zotee" target="_blank" rel="noopener noreferrer" className="social-link">
            ...
            <a href="https://www.linkedin.com/in/jyoti-shah7172/" target="_blank" rel="noopener noreferrer" className="social-link">
              <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
